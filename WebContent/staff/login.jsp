            ...
            <div class="row contact-wrap"> 
                ...
                <div class="col-md-6 col-md-offset-3">
                   <h5 style="color:red"><s:fielderror name="message"></s:fielderror></h5>
                    <form action="staff" method="post" role="form" class="contactForm">
                  ...
                  <s:a action="staff-register">Register Here!</s:a>
<span style="float:right"><s:a href="admin-login">Not Staff?</s:a></span>                              
                </div>
            </div><!--/.row-->
        </div><!--/.container-->
